    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        for (var i = 0; i < response.length; i++) {
          ...
          newRow.append(
            "<td style='align-items: center' class='align-items-center justify-content-center'><input class='form-control' style='width: 60px;'>" +
              "</td>"
          );
          newRow.append(

        ...
        <div class="col bg-white p-5 rounded bg">
            ...
            <form method="post" action="">
                <div class="input-group mb-4">
                    ...
                    <input name="email" id="email" class="form-control" type="email" placeholder="Correo Electrónico" maxlength="30">
                </div>
                <div class="d-grid">
                    <input type="submit" class="btn btn-primary btn-block" value="Restablecer" name="recuperarcontrasenabtn">
                </div>
                <br>
                <?php include "../Configuracion/Conexion.php";?>
                <?php include "../Controladores/Recuperacion.php";?>
            </form>
        </div>
    </div>
</div>

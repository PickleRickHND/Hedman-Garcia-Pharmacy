...
<div class="container w-75 bg-white mt-5 rounded shadow">
    <div class="row align-items-center align-items-stretch">
        ...
        <div class="col bg-white p-5 rounded bg">
            ...
            <h4 class="fw-bold text-center ру-5">Recuperación de Contraseña</h4>
            <br>
            <br>
            <form method="post" action="">
                <div class="input-group mb-4">
                    <span class="input-group-text" id="code"><i class="bi bi-patch-check-fill"></i></span>
                    <input name="code" id="code" class="form-control" placeholder="Ingrese el Codigo de Restablecimiento" maxlength="10">
                </div>
                <div class="d-grid">
                    <input type="submit" class="btn btn-primary btn-block" value="Verificar" name="validarcodigoabtn">
                </div>
                <br>
                <div class="d-grid">
                    <input type="submit" class="btn btn-secondary btn-block" value="Reenviar Codigo" name="reenviarcodigoabtn">
                </div>
                <br>
                <?php include "../Configuracion/Conexion.php";?>
                <?php include "../Controladores/Verificacion.php";?>
            </form>
        </div>
    </div>
</div>

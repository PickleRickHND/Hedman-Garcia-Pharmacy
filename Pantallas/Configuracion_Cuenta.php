...
<div class="container w-75 bg-white mt-5 rounded shadow">
    <div class="row align-items-center">
        ...
        <div class="col bg-white p-5 rounded bg">
            ...
            <h4 class="fw-bold text-center ру-5">Configuración de Cuenta</h4>
            <form method="post" action="">
                ...
                while ($datos=$seleccionar->fetch_object()){ ?>
                    ...
                    <div class="mb-3">
                        <label for="recipient-name3" class="col-form-label">Correo Electrónico:</label>
                ...
                <div class="fw-bold text-center">
                    <br>
                    <a type="button" class="btn btn-danger" href="Inicio.php">Cerrar</a>
                    <input type="submit" class="btn btn-primary" value="Modificar" name="editarusuarioconfiguracionbtn">
                    <a type="button" class="btn btn-warning" href="Cambio_Contrasena.php?id=<?= $datos2->id?>">Cambiar Contraseña</a>
                </div>
            </form>

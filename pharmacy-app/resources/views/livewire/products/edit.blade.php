<div>
    <x-slot name="header">
        <div>
            ...
            <h1 class="text-2xl font-bold text-surface-900 dark:text-surface-50">Editar: {{ $product->name }}</h1>
            <p class="mt-1 text-sm text-surface-500 dark:text-surface-400 font-mono">{{ $product->sku }}</p>
        </div>
    </x-slot>
            ...
            <form wire:submit="save">
                ...
                <div class="mt-6">
                    <x-ui.card>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <x-ui.input label="Stock" name="stock" type="number" min="0" wire:model="stock" :error="$errors->first('stock')" required />
                ...
                <div class="mt-6">
                    <x-ui.card>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <x-ui.input label="Presentación" name="presentation" wire:model="presentation" />
                            <x-ui.input label="Forma de administración" name="administration_form" wire:model="administration_form" />
                            <x-ui.input label="Almacenamiento" name="storage" wire:model="storage" />
                            <x-ui.input label="Empaque" name="packaging" wire:model="packaging" />
                        </div>

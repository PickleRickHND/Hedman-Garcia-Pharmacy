<div>
    <x-slot name="header">
        <div>
            ...
            <h1 class="text-2xl font-bold text-surface-900 dark:text-surface-50">Nuevo cliente</h1>
        </div>
    </x-slot>
            ...
            <form wire:submit="save">
                <x-ui.card>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <x-ui.input label="RTN" name="rtn" wire:model="rtn" :error="$errors->first('rtn')" hint="Ej: 0801-1985-12345" />
                    ...
                    <x-slot name="footer">
                        <div class="flex items-center justify-end gap-3">
                            ...
                            <x-ui.button type="submit" variant="primary">Crear cliente</x-ui.button>
                        </div>
                    </x-slot>
                </x-ui.card>
            </form>
